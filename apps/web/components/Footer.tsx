    ...
    <footer className="border-t border-slate-800 bg-slate-950 text-slate-300">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 lg:pl-8 space-y-3 text-sm text-slate-400 font-sans leading-relaxed">
              <p>
                From polyhouse microclimates in the Kathmandu Valley to expansive
                river-irrigated alluvial plots in Chitwan, Green Nepal Krishi Farm
              ...
              <div className="pt-2">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-krishi-sun hover:text-yellow-200 border-b border-krishi-sun/50 pb-0.5"
                >
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 text-xs">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5 text-slate-400 leading-relaxed font-sans">
              <p className="text-slate-200 font-medium">Chitwan Valley Facility</p>
              <p>Open Alluvial Fields &amp; Solar-Pump Irrigation</p>
            ...
            <div className="space-y-2 text-slate-400">
              <p>
                ...
                <a
                  ...
                  className="text-slate-200 hover:text-krishi-sun transition-colors"
                >
              ...
              <div className="pt-2">
                <a
                  ...
                  className="text-[11px] font-semibold text-krishi-sun hover:text-yellow-200 inline-flex items-center gap-1"
                >
                  Staff CMS Portal <ArrowUpRight className="h-3 w-3" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="mt-14 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-slate-500">
          <span>© {new Date().getFullYear()} Green Nepal Krishi Farm. All rights reserved.</span>
